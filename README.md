...
![botão de configurações](Imagens_tutorial/Config.png)
...
![Plugin Manager](Imagens_tutorial/PluginManager.png)
...
![Tela Plugin Manager](Imagens_tutorial/TelaPluginManager.png)
...
![instalando Plugin](Imagens_tutorial/Installing_Plugin.png)
...
![Reiniciar Octoprint](Imagens_tutorial/reiniciar.png)
...
![Confirmar Reinicio](Imagens_tutorial/confirmareinicio.png)

### Passo 6

Seu plugin já está instalado, agora vai nas 4  barrinhas do lado da opção time-lapse e clique na opção Fazenda 3D

![Plugin](Imagens_tutorial/Plugin1.png)

Essa é tela do plugin

![tela do plugin](Imagens_tutorial/TelaPlugin.png)
